...
import AddTicketPrice from "../../../pages/Admin/TicketPrice/AddTicketPrice";
import UpdateTicketPrice from "../../../pages/Admin/TicketPrice/UpdateTicketPrice";
import ReadTicketPrice from "../../../pages/Admin/TicketPrice/ReadTicketPrice";
 
  const TicketPriceList = () => {
  
    const columns = [
      { id: "id", name: "Id" },
      { id: "ticketName", name: "Ticket Name" },
      { id: "price", name: "Price/Km" },
    ...
    return (
      <div className="flex flex-col w-full">
          ...
          <Card className="h-[50px] w-full max-w-[100%]  ">
             ...
             <div className="w-[200px] h-full flex items-center ml-5">
              ...
              <div className="flex justify-between  w-[360px] mr-8 items-center"  >
                ...
                label="Input Success" style={{border: "1px solid #333", padding:"1px 8px", borderRadius:"3px", background:"#E8E8E8", color:"000"}} placeholder="Search ticket price name" />
   
                </form>
                <Button onClick={handleAddOpen} variant="contained" size="small" className="w-[240px] " sx={{background:"#6d28d9"}}>Add Ticket Price</Button>
              </div>
             </div>
                ...
                <TableContainer sx={{ maxHeight: 450 }}>
                  <Table stickyHeader>
                    ...
                    <TableBody>
                      {rows &&
                        rows.filter((item)=>{
                          return search.toLowerCase() === '' ? item : item.ticketName.
        ...
        {openDeleteModal && <DeleteLayout  open={openDeleteModal} handleClose={handleDeleteClose} idObject={idObject} objectLink={"TicketPrices"} />}
        
        {openAddModal && <AddTicketPrice  open={openAddModal} handleClose={handleAddClose} />}
        {openUpdateModal   &&  <UpdateTicketPrice  open={openUpdateModal} handleClose={handleUpdateClose} id={idObject}/>}

        {openReadModal   &&  <ReadTicketPrice  open={openReadModal} handleClose={handleReadClose} id={idObject}/>}
