...
const SeatPickerC = ({nameObject,scheduleId, selected}) => {
  const totalSeats = 22;
  ...
  return (
    <div>
    <h1 className='text-center mb-2 font-semibold text-xl text-gray-800 pl-0'>The bed is in a compartment with 4 air conditioners</h1>
