...
const SeatPicker = ({nameObject, scheduleId ,selected}) => {
  const totalSeats = 44;
  ...
  return (
    <div>
      <h1 className='pl-0 text-center mb-2 font-semibold text-xl text-gray-800'>Air-conditioned soft seat</h1>
